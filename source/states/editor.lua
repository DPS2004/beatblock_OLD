local st = {
  sprEditorSquare = gfx.image.new("assets/editor/editorSquare.png"),
  sprEditorPalette = gfx.image.new("assets/editor/editorPalette.png"),
  sprEditorRect51x26 = gfx.image.new("assets/editor/editorRect51x26.png"),
  sprEditorRect41x33 = gfx.image.new("assets/editor/editorRect41x33.png"),
  sprEditorSelected = gfx.image.new("assets/editor/editorSelected.png"),
  sprEditorPlaySymbol = gfx.image.new("assets/editor/editorPlaySymbol.png"),
  sprEditorTextBox = gfx.image.new("assets/editor/editorTextBox.png")
}
function st.init()
  ...
  if not paused then
    if maininput:pressed("back") then
      if st.editmode and st.selectedeventindex == nil then
        ...
        pup.text = gfx.getLocalizedText("savewarning")
        pup.w=200
        pup.h=100
        pup.newbutton({x=100,y=50,w=50,h=16,text=gfx.getLocalizedText("save"),onclick = function() st.savelevel() helpers.swap(states.songselect) paused = false pup.delete = true end})
        pup.newbutton({x=100,y=70,w=50,h=16,text=gfx.getLocalizedText("dontsave"),onclick = function() helpers.swap(states.songselect) paused = false pup.delete = true end})
        pup.newbutton({x=100,y=90,w=50,h=16,text=gfx.getLocalizedText("cancel"),onclick = function() paused = false pup.delete = true end})
      else
        st.stoplevel()
      end
    end
    ...
    if st.editmode then
      ...
      if maininput:down("ctrl") then
        if maininput:pressed("r") then
          ...
          local pup = em.init("popup",screencenter.x,screencenter.y)
          pup.text = gfx.getLocalizedText("refreshwarning")
          pup.w=200
          pup.h=100
        ...
        if maininput:pressed("e") or maininput:pressed("mouse3") or st.openpup == true then
          ...
          if st.eventindex then
            if st.level.events[st.eventindex].type == "hold" or "minehold" then
              ...
              local pup = em.init("popup",screencenter.x,screencenter.y)
              pup.text = gfx.getLocalizedText("editwhat")
              pup.w = 200
              pup.h=170
              pup.newbutton({x=100,y=40,w=50,h=16,text=gfx.getLocalizedText("angle1"),onclick = function()
                pup.h = 100
                pup.text = gfx.getLocalizedText("editing") .. " " .. gfx.getLocalizedText("angle1") .. ":"
                pup.buttons = {}
                pup.textinput= {text=tostring(st.level.events[st.eventindex].angle1),y=50,show=true,numberonly=true, allowminus=true}
                pup.newbutton({x=100,y=90,w=50,h=16,text=gfx.getLocalizedText("ok"),onclick = function() cs.level.events[st.eventindex].angle1 = tonumber(pup.textinput.text) paused = false pup.delete = true end})
                pup.newbutton({x=100,y=70,w=50,h=16,text=gfx.getLocalizedText("cancel"),onclick = function() paused = false pup.delete = true end})
              end})
              pup.newbutton({x=100,y=60,w=50,h=16,text=gfx.getLocalizedText("angle2"),onclick = function()
                pup.h = 100
                pup.text = gfx.getLocalizedText("editing") .. " " .. gfx.getLocalizedText("angle2") .. ":"
                pup.buttons = {}
                pup.textinput= {text=tostring(st.level.events[st.eventindex].angle2),y=50,show=true,numberonly=true, allowminus=true}
                pup.newbutton({x=100,y=90,w=50,h=16,text=gfx.getLocalizedText("ok"),onclick = function() cs.level.events[st.eventindex].angle2 = tonumber(pup.textinput.text) paused = false pup.delete = true end})
                pup.newbutton({x=100,y=70,w=50,h=16,text=gfx.getLocalizedText("cancel"),onclick = function() paused = false pup.delete = true end})
              end})
                pup.newbutton({x=100,y=80,w=50,h=16,text=gfx.getLocalizedText("holdease"),onclick = function()
                  pup.h = 100
                  pup.text = gfx.getLocalizedText("editing") .. " " .. gfx.getLocalizedText("holdease") .. ":"
                  pup.buttons = {}
                  pup.textinput= {text=tostring(st.level.events[st.eventindex].holdease or ""),y=50,show=true,numberonly=false}
                  pup.newbutton({x=100,y=90,w=50,h=16,text=gfx.getLocalizedText("ok"),onclick = function() cs.level.events[st.eventindex].holdease =   pup.textinput.text paused = false pup.delete = true end})
                  pup.newbutton({x=100,y=70,w=50,h=16,text=gfx.getLocalizedText("cancel"),onclick = function() paused = false pup.delete = true end})
              end})
              pup.newbutton({x=100,y=100,w=50,h=16,text=gfx.getLocalizedText("duration"),onclick = function()
                pup.h = 100
                pup.text = gfx.getLocalizedText("editing") .. " " .. gfx.getLocalizedText("duration") .. ":"
                pup.buttons = {}
                pup.textinput= {text=tostring(st.level.events[st.eventindex].duration),y=50,show=true,numberonly=true}
                pup.newbutton({x=100,y=90,w=50,h=16,text=gfx.getLocalizedText("ok"),onclick = function() cs.level.events[st.eventindex].duration = tonumber(pup.textinput.text) paused = false pup.delete = true end})
                pup.newbutton({x=100,y=70,w=50,h=16,text=gfx.getLocalizedText("cancel"),onclick = function() paused = false pup.delete = true end})
              end})
              pup.newbutton({x=100,y=120,w=50,h=16,text=gfx.getLocalizedText("time"),onclick = function()
                pup.h = 100
                pup.text = gfx.getLocalizedText("editing") .. " " .. gfx.getLocalizedText("time") .. ":"
                pup.buttons = {}
                pup.textinput= {text=tostring(st.level.events[st.eventindex].time),y=50,show=true,numberonly=true}
                pup.newbutton({x=100,y=90,w=50,h=16,text=gfx.getLocalizedText("ok"),onclick = function() cs.level.events[st.eventindex].time = tonumber(pup.textinput.text) paused = false pup.delete = true end})
                pup.newbutton({x=100,y=70,w=50,h=16,text=gfx.getLocalizedText("cancel"),onclick = function() paused = false pup.delete = true end})
              end})
              pup.newbutton({x=100,y=140,w=100,h=16,text=gfx.getLocalizedText("speedmult"),onclick = function()
                pup.h = 100
                pup.text = gfx.getLocalizedText("editing") .. " " .. gfx.getLocalizedText("speedmult") .. ":"
                pup.buttons = {}
                pup.textinput= {text=tostring(st.level.events[st.eventindex].speedmult),y=50,show=true,numberonly=true}
                pup.newbutton({x=100,y=90,w=50,h=16,text=gfx.getLocalizedText("ok"),onclick = function() cs.level.events[st.eventindex].speedmult = tonumber(pup.textinput.text) paused = false pup.delete = true end})
                pup.newbutton({x=100,y=70,w=50,h=16,text=gfx.getLocalizedText("cancel"),onclick = function() paused = false pup.delete = true end})
              end})
              pup.newbutton({x=100,y=160,w=50,h=16,text=gfx.getLocalizedText("cancel"),onclick = function() paused = false pup.delete = true end})
...
paused = true
              ...
              pup.w = 200
              pup.h=150
              pup.newbutton({x=100,y=60,w=60,h=16,text=gfx.getLocalizedText("startangle"),onclick = function()
                pup.h = 100
                pup.text = gfx.getLocalizedText("editing") .. " " .. gfx.getLocalizedText("startangle") .. ":"
                pup.buttons = {}
                pup.textinput= {text=tostring(st.level.events[st.eventindex].angle),y=50,show=true,numberonly=true, allowminus=true}
                pup.newbutton({x=100,y=90,w=50,h=16,text=gfx.getLocalizedText("ok"),onclick = function() cs.level.events[st.eventindex].angle = tonumber(pup.textinput.text) paused = false pup.delete = true end})
                pup.newbutton({x=100,y=70,w=50,h=16,text=gfx.getLocalizedText("cancel"),onclick = function() paused = false pup.delete = true end})
              end})
              pup.newbutton({x=100,y=80,w=50,h=16,text=gfx.getLocalizedText("endangle"),onclick = function()
                pup.h = 100
                pup.text = gfx.getLocalizedText("editing") .. " " .. gfx.getLocalizedText("endangle") .. ":"
                pup.buttons = {}
                ...
                pup.newbutton({x=100,y=90,w=50,h=16,text=gfx.getLocalizedText("ok"),onclick = function() cs.level.events[st.eventindex].endangle = tonumber(pup.textinput.text) paused = false pup.delete = true end})
                pup.newbutton({x=100,y=70,w=50,h=16,text=gfx.getLocalizedText("cancel"),onclick = function() paused = false pup.delete = true end})
              end})
              pup.newbutton({x=100,y=100,w=50,h=16,text=gfx.getLocalizedText("time"),onclick = function()
                pup.h = 100
                pup.text = gfx.getLocalizedText("editing") .. " " .. gfx.getLocalizedText("time") .. ":"
                pup.buttons = {}
                pup.textinput= {text=tostring(st.level.events[st.eventindex].time),y=50,show=true,numberonly=true}
                pup.newbutton({x=100,y=90,w=50,h=16,text=gfx.getLocalizedText("ok"),onclick = function() cs.level.events[st.eventindex].hb = tonumber(pup.textinput.text) paused = false pup.delete = true end})
                pup.newbutton({x=100,y=70,w=50,h=16,text=gfx.getLocalizedText("cancel"),onclick = function() paused = false pup.delete = true end})
              end})
              pup.newbutton({x=100,y=120,w=100,h=16,text=gfx.getLocalizedText("speedmult"),onclick = function()
                pup.h = 100
                pup.text = gfx.getLocalizedText("editing") .. " " .. gfx.getLocalizedText("speedmult") .. ":"
                pup.buttons = {}
                pup.textinput= {text=tostring(st.level.events[st.eventindex].speedmult),y=50,show=true,numberonly=true}
              ...
              pup.newbutton({x=100,y=140,w=50,h=16,text=gfx.getLocalizedText("cancel"),onclick = function() paused = false pup.delete = true end})
...
function st.savelevel()
  ...
  json.encodeToFile(clevel.."level.json",st.level)
end
